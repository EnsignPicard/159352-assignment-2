...
interface PassengerFormProps {
    onSubmit: (title: string, firstname: string, lastname: string, email: string) => void;
    loading: boolean;
    error: string;
}

const PassengerForm = ({ onSubmit, loading, error }: PassengerFormProps) => {
    ...
    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        onSubmit(title, firstname, lastname, email);
    };
